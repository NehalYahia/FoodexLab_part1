...
function MethodPageWIthoutConfirmation() {
    ...
    useEffect(() => {
        const sum =
            Number(rowsData.Counting1 || 0) +
            Number(rowsData.Counting2 || 0) +
            Number(rowsData.Counting3 || 0) +
            Number(rowsData.Counting4 || 0);
    ...
    useEffect(() => {
        if (!rowsData.volume || !rowsData.n1 || !rowsData.Dilution1) return;

        const result =
            Number(rowsData.sum) /
            (
                Number(rowsData.volume) *
                convertPower(rowsData.Dilution1) *
                (Number(rowsData.n1) + (0.2 * Number(rowsData.n2)))
            );
    ...
    useEffect(() => {
        setU(Math.sqrt(
            ((tech * tech) + (matrix * matrix) + (pois * pois))
        ));
    }, [tech, matrix, pois]);
    ...
    const handleSubmit = async (e) => {
        ...
        console.log("DTO Sent:", row); // للتأكد قبل الإرسال
                        ...
                        <div className="row container m-auto mt-5">
                            ...
                            <div class=" mb-3 col-1">
                                ...
                                <input type="number"
                                    ...
                                    /*onChange={(e) => setCounting1(e.target.value)}*/
                            ...
                            <div class="col-2 mb-3">
                                ...
                                <input type="number"
                                    ...
                                    class="form-control" placeholder="volume" aria-labelvolum="volume" aria-describedby="volume" />
                            </div>
                            ...
                            <div class="col-1 mb-3">
                                ...
                                <select class="form-select "
                                    value={rowsData.Dilution2 || sampleTestDetails.d2 || ""}
                                    onChange={(e) => setRowsData(prev => ({
                                        ...prev,
                            ...
                            <div class="col-2 mb-3">
                                ...
                                <input type="number"
                                    ...
                                    class="form-control" placeholder="sum" aria-label="sum" aria-describedby="sum" readOnly />
                            </div>
                            ...
                            <div class="col-2 mb-3">
                                ...
                                <select class="form-select"
                                    value={rowsData.unit || sampleTestDetails.unit || ""}
                                    onChange={(e) => setRowsData(prev => ({
                                        ...prev,
                                        unit: e.target.value,
                                    }))
...
export default MethodPageWIthoutConfirmation;